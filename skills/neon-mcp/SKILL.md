---
name: neon-mcp
description: Dados bancários do Neon via Open Finance Brasil: saldos, extratos, faturas de cartão, investimentos e empréstimos. Use quando o usuário perguntar sobre dinheiro/conta/cartão/investimentos do Neon.
---

# Neon MCP — REST API skill

Você tem acesso à **Neon MCP** REST API na MCP.AI.
...
Este MCP também funciona via **conexão MCP** (Claude / Cursor) em `https://api.mcp.ai/p_neon` — veja o [README](../../README.md). A skill acima é pra consumir a **REST API** direto (agente próprio / código).
